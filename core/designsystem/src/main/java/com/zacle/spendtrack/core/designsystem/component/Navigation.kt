...
/**
 * SpendTrack navigation bar item with icon and label content slots. Wraps Material 3
 * [NavigationBarItem].
 *
 ...
 */
@Composable
fun RowScope.STNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
...
/**
 * SpendTrack navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
...
/**
 * SpendTrack navigation rail item with icon and label content slots. Wraps Material 3
 * [NavigationRailItem].
 *
 * @param selected Whether this item is selected.
 * @param onClick The callback to be invoked when this item is selected.
...
/**
 * SpendTrack navigation rail with header and content slots. Wraps Material 3 [NavigationRail].
 *
...
/**
 * SpendTrack navigation default values
 */
object STNavigationDefaults {
    @Composable
