...
class SyncIncomeWorker(
    ...
    override suspend fun getForegroundInfo(): ForegroundInfo =
        context.syncIncomeForegroundInfo()
    ...
    override suspend fun doWork(): Result = withContext(ioDispatcher) {
        try {
            ...
            // Sync the data
            val syncedSuccessfully = incomeRepository.sync(userId)
    ...
    class Factory(
        ...
        override fun createWorker(
            ...
            if (workerClassName == SyncIncomeWorker::class.java.name) {
                SyncIncomeWorker(
                    context = appContext,
                    workerParams = workerParameters,
